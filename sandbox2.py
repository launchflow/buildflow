...
runtime_config = RuntimeConfig(
    ...
    num_threads_per_process=8,  # replica concurrency
    num_actors_per_core=2,  # num cpus per replica
    num_available_cores=10,  # make this a debug option (i.e. debug_options{core_limit})
    # autoscale options
    autoscale=True,
    min_replicas=1,
    max_replicas=20,
