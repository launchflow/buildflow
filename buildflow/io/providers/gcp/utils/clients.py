...
from google.cloud.bigquery_storage_v1.services.big_query_write.async_client import BigQueryWriteAsyncClient  # noqa: E501
...
def get_bigquery_write_async_client(
        project: str = None) -> bigquery_storage_v1.BigQueryWriteClient:
    creds = _get_gcp_creds(project)
