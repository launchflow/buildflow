...
from buildflow import exceptions, utils
from buildflow.api.composites.sink import Batch, Sink
from buildflow.api.composites.source import AckInfo, PullResponse, Source
...
class GCPPubSubSubscriptionProvider(Source, Sink, Provider):
    def __init__(
        self,
        *,
        # common options
...
class GCPPubSubTopicProvider(Sink, Provider):
